...
protected:
	...
	bool GainbFinancingBuy(CString BEntrustType);
	bool GainBuy335002(string &s_str, const CString stock_code, const double &entrust_price, UInt_64 &entrust_amount);
	DECLARE_MESSAGE_MAP()

private:
	map<CString, BOOL> m_mapCheckInfo;//CString为委托号
	CAlertSetting_Credit* m_pCAlertSetting;
	COLORREF m_clr;
...
private:
	...
	{
		{ ColId_whetherBiaoDi, "是否标的", 120, COLTYPE_FIX, FALSE }
