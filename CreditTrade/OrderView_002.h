...
protected:
	...
	bool GainRevoke335004(string &s_str, const UInt_64 entrust_no, const string &exchange_type);
	...
	static void GetVirtualCellText(CString &strText, PtrOrder pOrder, const int nColID);//根据列ID 获取文字
	static BOOL CompareOrderData(PtrOrder order1, PtrOrder order2);  //委托数据排序
    //获取每一个格子的数据
