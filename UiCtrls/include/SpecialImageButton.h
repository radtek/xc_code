...
#define SpecialImageButton_CLASSNAME    _T("CSpecialImageButton")

class CSpecialImageButton : public CWnd
{
	DECLARE_DYNAMIC(CSpecialImageButton)

public:
	CSpecialImageButton();
	virtual ~CSpecialImageButton();
