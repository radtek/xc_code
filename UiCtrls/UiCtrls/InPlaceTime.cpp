...
// CInPlaceTime from http://www.codeguru.com/listview/edit_subitems.shtml
//
...
CInPlaceTime::CInPlaceTime(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           ...
                           UINT nFirstChar)
{
    ...
    SetBoxShow(FALSE);
    SetMode(EDITABLE_WHILE_UNCHECKED);
...
BEGIN_MESSAGE_MAP(CInPlaceTime, CInputTime)
...
void CInPlaceTime::OnKillFocus(CWnd* pNewWnd)
{
    CInputTime::OnKillFocus(pNewWnd);
    EndEdit();
}

UINT CInPlaceTime::OnGetDlgCode() 
{
    return DLGC_WANTALLKEYS;
}

////////////////////////////////////////////////////////////////////////////
// CInPlaceTime overrides


// Auto delete
void CInPlaceTime::PostNcDestroy() 
{
    CInputTime::PostNcDestroy();
    
    delete this;	
}

void CInPlaceTime::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
//     if (nChar == VK_RETURN)
//     {
//         m_nLastChar = nChar;
...
//     }
    if (nChar == VK_ESCAPE) 
    {
        SetTime(m_sInitText);    // restore previous text
        m_nLastChar = nChar;
        GetParent()->SetFocus();
    }
    ...
    CInputTime::OnChar(nChar, nRepCnt, nFlags);
}

////////////////////////////////////////////////////////////////////////////
// CInPlaceTime implementation

void CInPlaceTime::EndEdit()
{
    CString str = GetTime();
