...
// CInPlaceHotkeyEdit from http://www.codeguru.com/listview/edit_subitems.shtml
//
...
CInPlaceHotkeyEdit::CInPlaceHotkeyEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           ...
                           UINT nFirstChar)
{
    ...
    DWORD dwEditStyle = WS_CHILD|WS_VISIBLE| ES_AUTOHSCROLL //|ES_MULTILINE
        | dwStyle;
...
CInPlaceHotkeyEdit::~CInPlaceHotkeyEdit()
{
}

BEGIN_MESSAGE_MAP(CInPlaceHotkeyEdit, CHotkeyEdit)
    //{{AFX_MSG_MAP(CInPlaceHotkeyEdit)
    ON_WM_KILLFOCUS()
    ON_WM_GETDLGCODE()
    ON_WM_CREATE()
    ON_WM_CHAR()
...
////////////////////////////////////////////////////////////////////////////
// CInPlaceHotkeyEdit message handlers

// As soon as this edit loses focus, kill it.
void CInPlaceHotkeyEdit::OnKillFocus(CWnd* pNewWnd)
{
    CEdit::OnKillFocus(pNewWnd);
    EndEdit();
}

UINT CInPlaceHotkeyEdit::OnGetDlgCode() 
{
    return DLGC_WANTALLKEYS;
}

////////////////////////////////////////////////////////////////////////////
// CInPlaceHotkeyEdit overrides


// Auto delete
void CInPlaceHotkeyEdit::PostNcDestroy() 
{
    CEdit::PostNcDestroy();
...
void CInPlaceHotkeyEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
//     if (nChar == VK_RETURN)
//     {
//         m_nLastChar = nChar;
...
////////////////////////////////////////////////////////////////////////////
// CInPlaceHotkeyEdit implementation

void CInPlaceHotkeyEdit::EndEdit()
{
    CString str;
