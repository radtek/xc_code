...
// CInPlaceButtonEdit from http://www.codeguru.com/listview/edit_subitems.shtml
//
...
CInPlaceButtonEdit::CInPlaceButtonEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                           int nRow, int nColumn, CString sInitText, 
						   UINT nFirstChar, double fTick, int nPrecision, int nDataType)
{
	...
	SetButtonStyle(UpDown);
	SetSize(rect.Width() - Def_BtnUpDownWidth);
	...
	if (TYPE_DOUBLE == nDataType)
	{
		SetDateType(TypeDouble);
	}
	else
	{
		SetDateType(TypeInt);
	...
	SetEditBkColor(RGB(18, 20, 22));
	SetTextOffset(0);
	CFont* pFont = pParent->GetFont();
	if (pFont != NULL)
	{
		InitSettings("", -1, (HFONT)pFont->GetSafeHandle());
	}
...
CInPlaceButtonEdit::~CInPlaceButtonEdit()
{
}

BEGIN_MESSAGE_MAP(CInPlaceButtonEdit, CSimpleButtonEdit)
    //{{AFX_MSG_MAP(CInPlaceButtonEdit)
    ON_WM_KILLFOCUS()
    ON_WM_GETDLGCODE()
//    ON_WM_CREATE()
    ON_WM_CHAR()
...
////////////////////////////////////////////////////////////////////////////
// CInPlaceButtonEdit message handlers

// As soon as this edit loses focus, kill it.
void CInPlaceButtonEdit::OnKillFocus(CWnd* pNewWnd)
{
	CSimpleButtonEdit::OnKillFocus(pNewWnd);
    EndEdit();
}

UINT CInPlaceButtonEdit::OnGetDlgCode() 
{
    return DLGC_WANTALLKEYS;
}

////////////////////////////////////////////////////////////////////////////
// CInPlaceButtonEdit overrides


// Auto delete
void CInPlaceButtonEdit::PostNcDestroy() 
{
	CSimpleButtonEdit::PostNcDestroy();
    
    delete this;	
}

void CInPlaceButtonEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
//     if (nChar == VK_RETURN)
//     {
//         m_nLastChar = nChar;
...
//     }
	...
	CSimpleButtonEdit::OnChar(nChar, nRepCnt, nFlags);
}

////////////////////////////////////////////////////////////////////////////
// CInPlaceButtonEdit implementation

void CInPlaceButtonEdit::EndEdit()
{
	CString str;
	GetWindowText(str);
...
BOOL CInPlaceButtonEdit::PreTranslateMessage(MSG* pMsg)
{
	if (WM_CHAR == pMsg->message && (VK_ESCAPE == pMsg->wParam || VK_RETURN == pMsg->wParam))
	{
	...
	return CSimpleButtonEdit::PreTranslateMessage(pMsg);
}
