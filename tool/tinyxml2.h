...
namespace tinyxml2
{
	...
	public:
		...
		virtual void SetTracked() override {
			--_nUntracked;
		}
	...
	protected:
		...
		virtual char* ParseDeep(char*, StrPair* endTag, int* curLineNumPtr) override;
	...
	protected:
		virtual char* ParseDeep(char* p, StrPair* endTag, int* curLineNumPtr) override;
	...
	public:
		...
		*/
		...
		void ClearError() {
			SetError(XML_SUCCESS, nullptr, nullptr, 0);
		}
