...
public:
	CString stock_name;
	CString stock_code;
	UInt_64 Buy_BusinessAmount;//总买数量
	UInt_64 Sell_BusinessAmount;//总卖数量
	double AverageBuyPrice;//买入均价
	double AverageSellPrice;//卖出均价
	double Buy_BusinessBalance;//总买金额
	double Sell_BusinessBalance;//总卖金额
	CDealSummary()
	{
		stock_name = "";
		stock_code = "";
